...
function calcularPatron() {
    ...
    if (tipoPrenda === 'CUBRE_PAÑAL') {
        ...
        // LÍNEA DE RAGLÁN: El 90% de Pecho a Sisa.
        ...
        // --- LÓGICA TOP-DOWN (Escote al Bajo - Raglán) ---
            ...
            // MODIFICACIÓN CRÍTICA: Se usa el Contorno de Cuello (medidas.CC) en lugar del Contorno de Pecho Ajustado (cpAjustadoCm).
            const puntosMontaje = Math.round(medidas.CC * densidadP); 
            ...
            resultado += `* **Montamos:** **${puntosMontaje} puntos** (**${medidas.CC.toFixed(1)} cm** de contorno de cuello).\n`; // Corregido a CC

// ====================================================================
// 1. DATOS Y MEDIDAS ANTROPOMÉTRICAS (CON CONTORNO DE CABEZA 'CCa' AÑADIDO)
// ====================================================================

const MEDIDAS_ANTROPOMETRICAS = {
    // Tallas de Bebé (Se añade CCa - Contorno de Cabeza)
    '00 (Prematuro)': { CP: 37.0, CC: 20.0, CA: 12.0, 'C Puño': 11.0, LT: 20.0, LM: 10.0, PSisa: 9.0, AE: 14.0, CED: 3.0, CCa: 34.0 },
    '0 meses': { CP: 39.0, CC: 21.0, CA: 13.0, 'C Puño': 12.0, LT: 22.0, LM: 12.0, PSisa: 10.0, AE: 16.0, CED: 3.5, CCa: 35.0 },
    '1-3 meses': { CP: 40.0, CC: 22.0, CA: 14.0, 'C Puño': 12.0, LT: 23.0, LM: 14.0, PSisa: 11.0, AE: 18.0, CED: 4.0, CCa: 42.0 },
    '3-6 meses': { CP: 44.0, CC: 23.0, CA: 16.0, 'C Puño': 12.5, LT: 24.0, LM: 16.0, PSisa: 12.0, AE: 20.0, CED: 4.5, CCa: 44.0 },
    '6-9 meses': { CP: 48.0, CC: 27.0, CA: 17.0, 'C Puño': 12.5, LT: 26.0, LM: 18.0, PSisa: 12.5, AE: 22.0, CED: 5.0, CCa: 46.0 },
    '9-12 meses': { CP: 52.0, CC: 25.0, CA: 18.0, 'C Puño': 12.5, LT: 28.0, LM: 20.0, PSisa: 13.0, AE: 24.0, CED: 5.5, CCa: 48.0 },
    '12-15 meses': { CP: 56.0, CC: 25.0, CA: 19.0, 'C Puño': 13.0, LT: 30.0, LM: 22.0, PSisa: 13.5, AE: 26.0, CED: 6.0, CCa: 49.0 },
    '15-18 meses': { CP: 60.0, CC: 26.0, CA: 20.0, 'C Puño': 13.5, LT: 32.0, LM: 25.0, PSisa: 14.0, AE: 28.0, CED: 6.5, CCa: 50.0 },
    '18-24 meses': { CP: 61.0, CC: 26.0, CA: 22.0, 'C Puño': 14.0, LT: 34.0, LM: 27.0, PSisa: 15.0, AE: 30.0, CED: 7.0, CCa: 51.0 },

    // Tallas de Niños (Se añade CCa)
    '3 años': { CP: 62.0, CC: 28.5, CA: 23, 'C Puño': 15.5, LT: 36.0, LM: 28.5, PSisa: 16.0, AE: 31.0, CED: 7.3, CCa: 51.0 }, 
    '4 años': { CP: 63.0, CC: 30.0, CA: 24.0, 'C Puño': 16.0, LT: 38.0, LM: 32.0, PSisa: 17.0, AE: 32.0, CED: 7.5, CCa: 52.5 },
    '6 años': { CP: 66.0, CC: 31.0, CA: 25.0, 'C Puño': 16.5, LT: 42.0, LM: 35.5, PSisa: 18.0, AE: 34.0, CED: 8.0, CCa: 54.5 },
    '8 años': { CP: 68.0, CC: 32.0, CA: 26.0, 'C Puño': 17.0, LT: 47.0, LM: 39.0, PSisa: 19.0, AE: 36.0, CED: 8.5, CCa: 55.5 },
    '10 años': { CP: 72.0, CC: 33.0, CA: 26.5, 'C Puño':18.0, LT: 50.0, LM: 43.0, PSisa: 20.0, AE: 38.0, CED: 9.0, CCa: 56.0 },
    
    // Tallas de Mujer (Adulto) (Se añade CCa)
    '36': { CP: 81.0, CC: 35.0, CA: 30.0, 'C Puño':19.3, LT: 58.0, LM: 47.0, PSisa: 22.0, AE: 35.0, CED: 11.0, CCa: 57.0 }, 
    '38': { CP: 86.0, CC: 36.0, CA: 32.0, 'C Puño': 19.5, LT: 60.0, LM: 48.0, PSisa: 22.5, AE: 36.0, CED: 11.5, CCa: 57.5 }, 
    '40': { CP: 92.0, CC: 37.0, CA: 33.0, 'C Puño': 20.6, LT: 61.0, LM: 48.5, PSisa: 23.0, AE: 36.8, CED: 12.0, CCa: 58.0 }, 
    '42': { CP: 100.0, CC: 38.0, CA: 35.0, 'C Puño': 20.8, LT: 62.0, LM: 49.0, PSisa: 24.0, AE: 37.6, CED: 12.5, CCa: 58.5 }, 
    '44': { CP: 104.0, CC: 40.0, CA: 37.0, 'C Puño': 21.5, LT: 63.0, LM: 50.0, PSisa: 25.0, AE: 38.6, CED: 13.0, CCa: 59.0 }, 
    '46': { CP: 108.0, CC: 39.0, CA: 38.0, 'C Puño': 22.2, LT: 64.0, LM: 51.0, PSisa: 26.0, AE: 39.6, CED: 13.5, CCa: 59.0 }, 
    '48': { CP: 112.0, CC: 40.0, CA: 39.0, 'C Puño': 23.4, LT: 66.0, LM: 52.0, PSisa: 27.0, AE: 40.6, CED: 14.0, CCa: 59.0 }, 
    '50': { CP: 116.0, CC: 41.0, CA: 40.0, 'C Puño': 23.6, LT: 68.0, LM: 54.0, PSisa: 28.0, AE: 41.6, CED: 14.5, CCa: 59.0 } 
};
...
function calcularPatron() {
    ...
    if (tipoPrenda === 'CUBRE_PAÑAL') {
        ...
        // ******************************************************************
        // INICIO: Variables que deben ser declaradas antes de BAJO o ESCOTE
        // (Este bloque se reinsertó para corregir el error de cálculo)
        // ******************************************************************
        
        // 1. Cálculos de Holgura de Cuerpo (8% del CP)
        const holguraCm = medidas.CP * 0.08; 
        ...
        // 3. Tapeta (solo para Chaqueta)
        const puntosTapeta = Math.max(3, Math.round(tiraCuelloCm * densidadP)); // Puntos de tapeta

        // 4. Variables que dependen del método (se declaran aquí para estar disponibles)
        let puntosSisaManga;
        let anchoSisaMangaCm;
        let holguraMangaCm;
        let ccPts; // Puntos de contorno de cuello
        
        // ******************************************************************
        // FIN: Variables declaradas
        // ******************************************************************
        ...
        if (metodoTejido === "BAJO") {
            ...
            // --- CÁLCULO DE SISA Y HOLGURA DE MANGA (Nueva Lógica solicitada) ---
            const talla = tallaSeleccionada;
            // Tallas de Bebé (00 a 18-24 meses)
            if (talla === '00 (Prematuro)' || talla === '0 meses') {
                holguraMangaCm = 1.0; // 1 cm
            } else if (ORDEN_TALLAS['Bebé (Prematuro a 24m)'].includes(talla)) {
                holguraMangaCm = 1.5; // 1.5 cm para el resto de bebé
            } 
            // Tallas de Niños (3 años a 10 años)
            else if (ORDEN_TALLAS['Niños (3 a 10 años)'].includes(talla)) {
                holguraMangaCm = 2.0; // 2 cm
            } 
            // Tallas de Adulto (36 a 50)
            else if (ORDEN_TALLAS['Adulto (36 a 50)'].includes(talla)) {
                holguraMangaCm = 2.5; // 2.5 cm
            } else {
                holguraMangaCm = 2.5; // Holgura por defecto (Adulto)
            }
            
            // Cálculo del ancho de sisa (Contorno de Axila / 2 + Holgura)
            anchoSisaMangaCm = (medidas.CA / 2) + holguraMangaCm;
            
            // Puntos de la sisa de la manga
            puntosSisaManga = Math.round(anchoSisaMangaCm * densidadP);
            // --- FIN CÁLCULO DE SISA (NUEVO) ---
            ...
            // puntosSisaManga está calculado arriba con la nueva lógica (CA/2 + holgura)
            ...
            if (aumentosPorLado > 0) {
                ...
                // LÍNEA DE OUTPUT MODIFICADA (cambio de "contorno" a "ancho")
                resultado += `* **Aumentos:** Aumentar **1 punto a cada lado** **${aumentosPorLado} veces** con una frecuencia de **${frecuenciaStr}**. Esto lleva la manga a **${puntosSisaManga} puntos** (**${cmSisaFinal} cm** de ancho en la sisa, incluyendo **${holguraMangaCm.toFixed(1)} cm** de holgura).\n\n`;
            } else {

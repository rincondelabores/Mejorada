...
const MEDIDAS_ANTROPOMETRICAS = {
    ...
    '00 (Prematuro)': { CP: 37.0, CC: 20.0, CA: 11.0, 'C Puño': 9.0, LT: 20.0, LM: 10.0, PSisa: 9.0, AE: 14.0, CED: 3.0 },
    '0 meses': { CP: 38.0, CC: 21.0, CA: 12.0, 'C Puño': 10.0, LT: 22.0, LM: 12.0, PSisa: 10.0, AE: 16.0, CED: 3.5 },
    '1-3 meses': { CP: 40.0, CC: 22.0, CA: 13.0, 'C Puño': 10.0, LT: 23.0, LM: 14.0, PSisa: 11.0, AE: 18.0, CED: 4.0 },
    '3-6 meses': { CP: 42.0, CC: 23.0, CA: 14.0, 'C Puño': 11.0, LT: 24.0, LM: 16.0, PSisa: 12.0, AE: 20.0, CED: 4.5 },
    '6-9 meses': { CP: 44.0, CC: 27.0, CA: 15.0, 'C Puño': 11.5, LT: 26.0, LM: 18.0, PSisa: 12.5, AE: 22.0, CED: 5.0 },
    '9-12 meses': { CP: 46.0, CC: 25.0, CA: 16.0, 'C Puño': 12.0, LT: 28.0, LM: 20.0, PSisa: 13.0, AE: 24.0, CED: 5.5 },
    '12-15 meses': { CP: 47.0, CC: 25.0, CA: 16.0, 'C Puño': 12.0, LT: 30.0, LM: 22.0, PSisa: 13.5, AE: 26.0, CED: 6.0 },
    '15-18 meses': { CP: 48.0, CC: 26.0, CA: 17.0, 'C Puño': 12.5, LT: 32.0, LM: 25.0, PSisa: 14.0, AE: 28.0, CED: 6.5 },
    '18-24 meses': { CP: 50.0, CC: 26.0, CA: 18.0, 'C Puño': 13.0, LT: 34.0, LM: 27.0, PSisa: 15.0, AE: 30.0, CED: 7.0 },

    // Tallas de Niños (Se mantienen los datos anteriores)
    '3 años': { CP: 56.0, CC: 26.5, CA: 23, 'C Puño': 13.0, LT: 36.0, LM: 28.5, PSisa: 16.0, AE: 31.0, CED: 7.3 }, 
    '4 años': { CP: 60.0, CC: 27.0, CA: 24.0, 'C Puño': 14.0, LT: 38.0, LM: 32.0, PSisa: 17.0, AE: 32.0, CED: 7.5 },
    '6 años': { CP: 62.0, CC: 28.0, CA: 25.0, 'C Puño': 15.0, LT: 42.0, LM: 35.5, PSisa: 18.0, AE: 34.0, CED: 8.0 },
    '8 años': { CP: 64.0, CC: 29.0, CA: 26.0, 'C Puño': 15.5, LT: 47.0, LM: 39.0, PSisa: 19.0, AE: 36.0, CED: 8.5 },
    '10 años': { CP: 68.0, CC: 30.0, CA: 26.0, 'C Puño':16.0, LT: 50.0, LM: 43.0, PSisa: 20.0, AE: 38.0, CED: 9.0 },
    
    // Tallas de Mujer (Adulto)
    '36': { CP: 82.0, CC: 33.0, CA: 26.0, 'C Puño':16.0, LT: 57.0, LM: 47.0, PSisa: 22.0, AE: 35.0, CED: 11.0 }, 
    '38': { CP: 86.0, CC: 34.0, CA: 27.0, 'C Puño': 16.5, LT: 58.0, LM: 48.0, PSisa: 22.5, AE: 36.0, CED: 11.5 }, 
    '40': { CP: 92.0, CC: 35.0, CA: 28.0, 'C Puño': 17.0, LT: 59.0, LM: 48.5, PSisa: 23.0, AE: 36.8, CED: 12.0 }, 
    '42': { CP: 100.0, CC: 36.0, CA: 30.0, 'C Puño': 18.0, LT: 60.0, LM: 49.0, PSisa: 24.0, AE: 37.6, CED: 12.5 }, 
    '44': { CP: 104.0, CC: 37.0, CA: 32.0, 'C Puño': 19.0, LT: 62.0, LM: 50.0, PSisa: 25.0, AE: 38.6, CED: 13.0 }, 
    '46': { CP: 108.0, CC: 38.0, CA: 34.0, 'C Puño': 20.0, LT: 64.0, LM: 51.0, PSisa: 26.0, AE: 39.6, CED: 13.5 }, 
    '48': { CP: 112.0, CC: 39.0, CA: 36.0, 'C Puño': 21.0, LT: 66.0, LM: 52.0, PSisa: 27.0, AE: 40.6, CED: 14.0 }, 
    '50': { CP: 116.0, CC: 40.0, CA: 38.0, 'C Puño': 22.0, LT: 68.0, LM: 54.0, PSisa: 28.0, AE: 41.6, CED: 14.5 } 
};
...
const MEDIDAS_GORRO = {
   ...
   // MEDIDAS DE GORRO
     ...
     'RN- 0': { CC: 34.0, ALT: 12.0, COR: 4.0, REC: 7.0, VUE: 2.0 }, 
     '1-3 meses': { CC: 38.0, ALT: 14.0, COR: 4.0, REC: 9.0, VUE: 2.0 }, 
     '3-6 meses': { CC: 42.0, ALT: 17.0, COR: 5.0, REC: 9.5, VUE: 2.0 }, 
     '6 meses-2 años': { CC: 46.0, ALT: 19.0, COR: 5.0, REC: 10.5, VUE: 2.5 }, 
     'Niños': { CC: 50.0, ALT: 21.0, COR: 5.0, REC: 12.0, VUE: 3.0 }, 
     'Adolescentes': { CC: 54.0, ALT: 23.0, COR: 6.0, REC: 13.0, VUE: 4.0 }, 
